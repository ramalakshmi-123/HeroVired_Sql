              ...
              <div className="container-fluid  ">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent" >
                  ...
                  <li className="nav-item">
                      <Link to='/login' className="nav-link active me-4" style={{textDecoration:'none',color:'#07588a',fontSize:"20px"}}>Login</Link>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <Link to='/contact' className="nav-link active me-4" style={{textDecoration:'none',color:'#07588a',fontSize:"20px"}}>Contact</Link>
                    </li>
                  </div>
                </div>
              </div>
